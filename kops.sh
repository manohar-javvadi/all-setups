...
export KOPS_STATE_STORE=s3://manu77.flm.k8s
kops create cluster --name manu77.k8s.local --zones us-east-1a --master-count=1 --master-size t2.medium --node-count=2 --node-size t2.medium
kops update cluster --name manu77.k8s.local --yes --admin
